<template>
  <header class="topbar">
    <div class="topbar-left">
      ...
      <IconButton v-if="isMobile && (route.name === 'note-detail' || route.name === 'settings')" @click="goBack"
      ...
      <IconButton v-else @click="uiStore.toggleSidebar" aria-label="Toggle Sidebar" :active="uiStore.isSidebarOpen">
        <!-- Sidebar Toggle Icon -->
        <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none"
          stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
    ...
    <div class="topbar-right">
      ...
      <IconButton v-if="route.name !== 'settings'" @click="uiStore.toggleOutline" aria-label="Toggle Outline"
